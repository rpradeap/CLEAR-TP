...
Remote_Data <- Remote_Data%>%filter(Year < 2019) #2019 data is incomplete
...
ggsave("C:\\Research\\TP Analysis\\Figures\\Figure 1\\Multiyear_MeanTP.png", plot = tp_usaplot_with_hist, width = 10, height = 8, units = "in", dpi = 1000)
```
